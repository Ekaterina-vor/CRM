    ...
    <main class="main">
        <div class="container">
            <div class="promotions-header">
                <h1 class="promotions-title">Акции</h1>
                <div class="promotions-filters">
                    <button class="promotion-filter <?php echo (!isset($_GET['status']) || $_GET['status'] === 'all') ? 'active' : ''; ?>" onclick="window.location.href='?status=all'">
                        Все
                    </button>
                    <button class="promotion-filter <?php echo (isset($_GET['status']) && $_GET['status'] === 'active') ? 'active' : ''; ?>" onclick="window.location.href='?status=active'">
                        Активные
                    </button>
                    <button class="promotion-filter <?php echo (isset($_GET['status']) && $_GET['status'] === 'ended') ? 'active' : ''; ?>" onclick="window.location.href='?status=ended'">
                        Завершенные
                    </button>
                </div>
                    ...
                    foreach ($promotions as $promo) {
                        ...
                        <div class='promotion-card'>
                            <div class='promotion-header'>
                                <span class='promotion-id'>#" . $promo['id'] . "</span>
                                <span class='promotion-code'>" . htmlspecialchars($promo['code_promo']) . "</span>
                            </div>
                        ...
                        if ($promo['path_to_image']) {
                            echo "<div class='promotion-files'>
                                    <a href='javascript:void(0)' onclick='showFile(\"" . htmlspecialchars($promo['path_to_image']) . "\", \"image\")' class='promotion-file'>
                        ...
                        echo "<div class='promotion-status-container'>
                            ...
                            <div style='display: flex; gap: 10px; margin-top: 10px;'>
                                <button class='promotion-btn' onclick='editPromotion(" . json_encode($promo) . ")'><i class='fa fa-edit'></i> Редактировать</button>
                                <button class='promotion-btn delete' onclick='deletePromotion(" . $promo['id'] . ")'><i class='fa fa-trash'></i> Удалить</button>
                            </div>
                        </div>";
                    }
                ?>
