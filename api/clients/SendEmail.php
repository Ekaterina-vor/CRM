...
// Отправка письма или вывод для тестирования
...
$mail->Password = 'c2Wg5sMHUniL3weNTiuJ';
$mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;
$mail->Port = 465;

// Добавляем изображения с абсолютными путями
$mail->addEmbeddedImage($_SERVER['DOCUMENT_ROOT'] . '/crm/img/1.jpg', 'background', 'background.jpg');
$mail->addEmbeddedImage($_SERVER['DOCUMENT_ROOT'] . '/crm/img/logo.png', 'logo', 'logo.png');

// Почта отправителя
$mail->setFrom('dima.haunov@mail.ru', 'Dima Haunov');
// Почта получателя
$mail->addAddress('ekaterina-v-04@mail.ru', 'Ekaterina');
